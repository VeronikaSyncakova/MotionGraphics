...
Game::Game() :
	m_window{ sf::VideoMode{ 800U, 600U, 32U }, "Pacman" },
...
/// <summary>
/// set up and initialise games objects
/// </summary>
void::Game::initialise()
{
	...
	bottomLine.setPosition(sf::Vector2f(100.0f, 300.0f));
...
void Game::setupFood()
{
	...
	for (int i = 0; i < 10; i++)
	{
		...
		if (i == cherryIndex)
		{
			food.initialise(true, x);
		}
		else
		{
			food.initialise(false, x);
		}
